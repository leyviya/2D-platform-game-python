...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for x in range(0, 1250, 64):
            wall = arcade.Sprite("images/tiles/planetMid.png", TILE_SCALING)
            wall.center_x = x
            wall.center_y = 32
        ...
        for coordinate in coordinate_list:
            ...
            wall = arcade.Sprite("images/tiles/brickGrey.png", TILE_SCALING)
            wall.position = coordinate
            self.wall_list.append(wall)

        # Use a loop to place some coins for our character to pick up
        for x in range(128, 1250, 256):
            coin = arcade.Sprite("images/items/coinSilver.png", COIN_SCALING)
            coin.center_x = x
            coin.center_y = 96
